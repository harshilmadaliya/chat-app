...
import { Menu, NotebookPen, UserPlus, X } from 'lucide-react'
...
import FriendRequestsShow from './FriendRequestsShow'
      ...
      <div className='w-full flex justify-between items-center'>
        <Link
          ...
          className={button({ variant: 'ghost' })}>
           <NotebookPen  className="text-indigo-600 -mx-3 h-8 w-auto" />
                  ...
                  <Dialog.Panel className='pointer-events-auto w-screen max-w-md'>
                    <div className='flex h-full flex-col overflow-hidden bg-white py-6 shadow-xl'>
                      ...
                      <div className='relative mt-6 flex-1 px-4 sm:px-6'>
                        ...
                        {friends.length > 0 ? (
                          <div className='text-xs font-semibold my-2 leading-6 text-gray-400'>
                            Your chats
                          </div>
                        ) : null}
